...
class TestSignUpFormElements:
    ...
    def test_form_field_placeholders(self):
        ...
        assert self.signup_page.password.get_attribute("placeholder") == "Enter at least 6 characters", "Incorrect placeholder for Password"
        assert self.signup_page.confirm_password.get_attribute("placeholder") == "Confirm your password", "Incorrect placeholder for Confirm Password"
    ...
    def test_login_button_redirect(self, page):
        ...
        assert page.url == "https://wize-invoice-dev-front.octaprimetech.com/login", \
